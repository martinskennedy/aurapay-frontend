...
export default function QuickStats() {
  ...
  return (
    <div className="pb-16 grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 max-w-4xl mx-auto">
      {stats.map((stat, i) => (
        <motion.div
          key={i}
        ...
        >
          <div className="flex items-start justify-between mb-4">
            <div className={`p-3 rounded-2xl group-hover:scale-110 transition-transform duration-300 ${stat.bg} ${stat.color}`}>
              {stat.icon}
            </div>
